-- Phase 1: Create missing tables for admin dashboard (Fixed)
...
-- Create policies for plan images
...
-- Create policies for slider images
...
-- Create policies for brand assets
